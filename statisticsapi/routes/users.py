...
@app.route("/api/v1/users/update_usergroup/<int:userId>", methods=['PUT'])
# @jwt_required
def update_usergroup(userId):
    """
        Function to update usergroup
        :return success message:
    """
    return User_Controller.update_usergroup(userId)
...
@app.route("/api/v1/users/country/<int:userId>", methods=['PUT'])
# @jwt_required
def update_country(userId):
    """
        ...
        :return success message:
    """
    return User_Controller.update_country(userId)